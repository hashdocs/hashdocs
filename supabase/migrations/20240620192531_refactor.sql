...
drop policy "ALL if user belongs to org" on "public"."tbl_document_versions";

drop policy "ALL if user org owns document" on "public"."tbl_documents";

drop policy "ALL if user org owns feedback" on "public"."tbl_feedback";

drop policy "ALL if document belongs to user org" on "public"."tbl_links";

drop policy "ALL if user belongs to org" on "public"."tbl_view_logs";

drop policy "ALL if viewer" on "public"."tbl_view_logs";

drop policy "ALL if user belongs to org" on "public"."tbl_views";
...
alter table "public"."tbl_document_versions" drop column "created_at";

alter table "public"."tbl_document_versions" drop column "is_enabled";

alter table "public"."tbl_document_versions" add column "file_type" text;

alter table "public"."tbl_document_versions" add column "is_active" boolean not null default true;

alter table "public"."tbl_document_versions" add column "org_id" uuid not null default gen_random_uuid();

alter table "public"."tbl_document_versions" add column "source_path" text not null;

alter table "public"."tbl_document_versions" add column "source_type" text not null default 'LOCAL'::text;

alter table "public"."tbl_document_versions" add column "thumbnail_image" text;

alter table "public"."tbl_document_versions" add column "token" text;

alter table "public"."tbl_document_versions" add column "updated_at" timestamp with time zone not null default now();

alter table "public"."tbl_document_versions" add column "updated_by" text default auth.email();

alter table "public"."tbl_documents" drop column "created_by";

alter table "public"."tbl_documents" drop column "document_seq";

alter table "public"."tbl_documents" drop column "image";

alter table "public"."tbl_documents" drop column "source_path";

alter table "public"."tbl_documents" drop column "source_type";

alter table "public"."tbl_documents" add column "custom_image" text;
