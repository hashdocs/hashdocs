...
//                       className="text-xs text-shade-gray-500/80"
//                     >
...
//                     <p className="text-xs text-shade-gray-500/80">
...
//                     <button
//                       type="button"
//                       className="inline-flex justify-center rounded-md px-3 py-2 text-xs text-shade-gray-500 hover:text-shade-pencil-black hover:underline"
...
//           {label}
//         </label>
//         <p className="text-xs text-shade-gray-500/80">{description}</p>
//       </div>
