  ...
  return (
    <div className="mx-auto flex max-w-screen-xl flex-col items-center p-4 text-center">
      ...
      <div className="mx-auto mt-10 flex max-w-fit space-x-4">
        <Link
          className="bg-stratos-default hover:bg-stratos-default/80 flex items-center justify-center space-x-2 rounded-lg border px-5 py-2 shadow-lg transition-all text-white"
          href="/login"
          target="_blank"
        >
        ...
        <Link
          className="flex items-center justify-center space-x-2 rounded-lg border bg-white px-5 py-2 shadow-lg transition-all hover:border-shade-pencil-dark"
