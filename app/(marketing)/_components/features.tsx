...
export default function Features() {
  ...
  return (
    <div id="features" className="w-full items-center flex flex-col py-10 border-y border-shade-line">
      ...
      <div className="">
        <div className="mx-auto max-w-screen-xl text-center">
          <h2 className="font-display text-4xl font-extrabold leading-tight text-black sm:text-5xl sm:leading-tight">
            <span className="bg-gradient-to-r from-stratos-400 via-stratos-default to-stratos-600 bg-clip-text text-transparent">
              Powerful
            </span>{" "}
            features for{" "}
            <span className="bg-gradient-to-r from-stratos-400 via-stratos-default to-stratos-600 bg-clip-text text-transparent">
          ...
          <p className="mt-5 text-gray-600 sm:text-lg">
            Never send an attachment again! We built a powerful suite to manage access to all your sensitive documents
          </p>
        </div>

        <div className="my-10 h-[840px] max-w-screen-xl w-full overflow-hidden rounded-xl border border-gray-200 bg-white/10 shadow-[inset_10px_-50px_94px_0_rgb(199,199,199,0.2)] backdrop-blur lg:h-[630px]">
